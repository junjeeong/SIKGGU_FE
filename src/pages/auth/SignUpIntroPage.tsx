...
const SignUpIntroPage = () => {
  ...
  return (
    <AuthPageLayout className="justify-center py-0">
      <div className="bg-sikggu-primary-50 shadow-lg w-full h-[45vh] flex flex-col items-center justify-center p-10 rounded-xl">
      ...
      {/* 자취생/1인 가구 버튼 */}
      <div className="bg-sikggu-primary-50 shadow-lg w-full h-[45vh] mt-10 flex flex-col items-center justify-center p-10 rounded-xl">
        <div className="flex flex-col justify-center w-full gap-1">
